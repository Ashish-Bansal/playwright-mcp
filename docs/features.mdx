...
title: playwright-mcp Features and Commands - Complete Reference Guide
sidebar_position: 3
description: Comprehensive guide to playwright-mcp features including Browser Toolbox and MCP Commands. Learn about recording interactions, DOM selection, screenshot capture, and executing custom Playwright code. Essential reference for test automation engineers.
keywords: [playwright-mcp features, browser automation, DOM selection, test recording, MCP commands, Playwright testing, screenshot capture, selector validation, browser toolbox, test automation tools]
---
