...
<img src="/img/claude-add-mcp.png" alt="Claude Desktop MCP Tools" className="img-large" />
...
<img src="/img/claude-browser-init.png" alt="Initialize Browser in Claude" className="img-responsive" />
...
<img src="/img/claude-get-context.png" alt="Getting Test Context in Claude" className="img-large" />
...
<img src="/img/claude-generate-testcase.png" alt="Generate Test Case in Claude" className="img-responsive" />
