...
title: How to Use playwright-mcp with Claude Desktop - Complete Guide
sidebar_position: 1
description: Learn to create powerful Playwright tests using Claude Desktop and playwright-mcp. Detailed guide on leveraging AI for test automation, from browser interaction to generating context-aware test scripts. Perfect for QA engineers and automation testers.
keywords: [Claude Desktop, playwright-mcp, AI testing, test automation, Playwright testing, automated QA, web testing, DOM interaction, test generation, end-to-end testing]
---
