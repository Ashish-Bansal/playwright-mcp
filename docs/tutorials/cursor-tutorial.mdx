...
<img src="/img/cursor-init-browser.png" alt="Initialize Browser in Cursor" className="img-responsive" />
...
<img src="/img/browser-recording.png" alt="Recording Browser Actions" className="img-responsive" />

### **Step 3: Add Extra Context (The Secret Sauce for Better Tests)**

<img src="/img/browser-get-dom.png" alt="Getting DOM Context" className="img-responsive" />
...
<img src="/img/cursor-get-context.png" alt="Getting Test Context in Cursor" className="img-medium" />
...
<img src="/img/cursor-generate-testcase.png" alt="Generate Test Case in Cursor" className="img-responsive" />
...
Now that you understand how to write a basic test case, head over to [advanced features](/docs/glossary) for more advanced usage. 
