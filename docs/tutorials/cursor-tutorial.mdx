...
title: How to Use playwright-mcp with Cursor IDE - Complete Guide
sidebar_position: 2
description: Master Playwright test automation in Cursor IDE with this comprehensive guide. Learn how to record interactions, extract DOM context, and generate reliable test cases using AI. Step-by-step tutorial for creating end-to-end tests with playwright-mcp.
keywords: [Cursor IDE, playwright-mcp, test automation, web testing, DOM extraction, AI test generation, end-to-end testing, Playwright tutorial, automated testing, test recording]
---
